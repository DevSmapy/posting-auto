...
| 5 | Notify draft → 마크다운 export | Discord/Telegram/Slack · **① 내용 게이트 → ② 렌더(이미지) 게이트 → cleanup** 후 `briefing.md` |
...
| Approve에 이미지 없음 | Browserless/`CARD_SCREENSHOT_BIN`, `DRAFT_START_BROWSERLESS` |
